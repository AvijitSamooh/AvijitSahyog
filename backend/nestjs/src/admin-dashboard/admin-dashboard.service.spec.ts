...
describe('AdminDashboardService', () => {
  ...
  it('maps audience, activity and engagement trend metrics', async () => {
    prisma.$queryRaw
      .mockResolvedValueOnce([{
        ...
        mau: BigInt(12),
        newUsers: BigInt(7),
        returningUsers: BigInt(5),
      }])
      .mockResolvedValueOnce([{
        sessions: BigInt(20),
        screenViews: BigInt(80),
        interactions: BigInt(40),
        navigationEvents: BigInt(25),
      }])
      .mockResolvedValueOnce([{
        day: new Date('2026-09-12T00:00:00.000Z'),
        activeUsers: BigInt(4),
        sessions: BigInt(6),
        screenViews: BigInt(18),
        interactions: BigInt(9),
      }]);
