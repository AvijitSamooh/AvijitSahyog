CREATE TABLE "AnalyticsEvent" ("id" UUID NOT NULL DEFAULT gen_random_uuid(), "clientId" VARCHAR(64) NOT NULL, "sessionId" VARCHAR(64) NOT NULL, "eventName" VARCHAR(64) NOT NULL, "screenName" VARCHAR(64), "interactionType" VARCHAR(32), "target" VARCHAR(128), "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, CONSTRAINT "AnalyticsEvent_pkey" PRIMARY KEY ("id"));
