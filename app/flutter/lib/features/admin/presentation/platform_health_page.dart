        ...
        data: (data) => RefreshIndicator(
          ...
          child: ListView(
            ...
            children: [
              ...
              _MetricGrid(metrics: [
                _Metric(l10n.adminApiErrors, data.errors24h, Icons.error_outline_rounded),
                _Metric(l10n.adminAuthFailures, data.authFailures24h, Icons.lock_outline_rounded),
                _Metric(l10n.adminUploadFailures, data.uploadFailures24h, Icons.cloud_upload_outlined),
                _Metric(l10n.adminAppErrors, data.appErrors24h, Icons.bug_report_outlined),
                _Metric(l10n.adminCrashes, data.crashes24h, Icons.warning_amber_rounded),
              ]),
