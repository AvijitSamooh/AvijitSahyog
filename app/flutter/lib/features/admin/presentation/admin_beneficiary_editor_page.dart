...
class _AdminBeneficiaryEditorPageState
  ...
  @override
  void dispose() {
    for (final controller in [_name, _photoUrl, _story, _year, _amount, _displayOrder]) {
      controller.dispose();
    }
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(_editing ? 'Edit beneficiary' : 'Create beneficiary')),
      body: ListView(
        ...
        children: [
          ...
          TextField(controller: _photoUrl, decoration: const InputDecoration(labelText: 'Photo URL')),
