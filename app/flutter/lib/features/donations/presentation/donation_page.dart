        ...
        data: (causes) {
          ...
          return ListView(padding: const EdgeInsets.fromLTRB(20, 20, 20, 32), children: [
            ...
            if (_step == 0) ...[
              ...
              const SizedBox(height: 12), Text("${l10n.totalAllocation}: $_allocationTotal%", key: const ValueKey("donation_allocation_total"), style: theme.textTheme.titleMedium),
            ] else ...[
              ...
              ...selectedCauses.map((cause) { final percentage = _allocationPercentages[cause.id] ?? 0; return Card(child: ListTile(title: Text(cause.name), subtitle: Text("$percentage%"), trailing: Text("₹ ${(_totalAmount * percentage / 100).toStringAsFixed(2)}"))); }),
