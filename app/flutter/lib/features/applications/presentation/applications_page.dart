...
class _HelpApplicationFormPageState extends ConsumerState<HelpApplicationFormPage> {
  ...
  Future<void> _pickImages() async {
    ...
    try {
      ...
      if (mounted) _showError(AppLocalizations.of(context)!.selectImagesFailed.replaceFirst('{error}', error.toString()));
    }
  }
  ...
  Future<void> _takePhoto() async {
    ...
    try {
      ...
      if (mounted) _showError(AppLocalizations.of(context)!.captureImageFailed.replaceFirst('{error}', error.toString()));
    }
  }
  ...
  String? _required(String? value, String label) => value == null || value.trim().isEmpty ? AppLocalizations.of(context)!.fieldRequired(label) : null;

  String? _mobileValidator(String? value) {
    final required = _required(value, AppLocalizations.of(context)!.mobileNumberRequired);
    if (required != null) return required;
    return RegExp(r'^\+?[0-9]{10,13}
  }

  String? _pincodeValidator(String? value) {
    final required = _required(value, AppLocalizations.of(context)!.pincodeRequired);
    if (required != null) return required;
...
).hasMatch(value!.trim()) ? null : AppLocalizations.of(context)!.mobileNumberInvalid;
  }
...
).hasMatch(value!.trim()) ? null : AppLocalizations.of(context)!.pincodeInvalid;
  }
